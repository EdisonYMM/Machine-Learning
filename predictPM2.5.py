...
raw_data = np.genfromtxt('train.csv',delimiter=',',encoding='gb18030') ##train.csv
data = raw_data[1:,3:]
...
test_raw_data = np.genfromtxt('test.csv',delimiter=',',encoding='gb18030')
test_data = test_raw_data[:,2:]
where_are_NaNs = np.isnan(test_data) ##找到未占位的 并给其赋值为 0
